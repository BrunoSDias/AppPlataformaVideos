class Admin::CategoriesController < Admin::ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @admin_category.save
        format.html { redirect_to admin_administrator_category_path(@administrator, @admin_category), notice: "Categoria foi criado com sucesso." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to  admin_administrator_categories_path(@administrator), notice: "Categoria foi removido com sucesso." }
  ...
  private
    ...
    def admin_category_params
      params[:admin_category][:admin_administrator_id] = @administrator
      params.require(:admin_category).permit(:nome, :descricao, :link, :admin_administrator_id)
    end
end
